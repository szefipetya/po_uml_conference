...
public class SessionStateHandler extends TextWebSocketHandler {
    ...
    Pair<UserWebSocketWrapper,EditorSession> latestsessionWhereUserExited;

    @Override
    public void afterConnectionClosed(WebSocketSession session, CloseStatus status) throws Exception {
        Pair<UserWebSocketWrapper,EditorSession> sockAndSession =this.service.findSessionForNativeSocketAndReturnUserSocket(SOCKET.STATE,session);
