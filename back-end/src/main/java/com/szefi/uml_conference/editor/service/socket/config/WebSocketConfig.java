package com.szefi.uml_conference.editor.service.socket.config;

import com.szefi.uml_conference.editor.service.socket.handler.SessionStateHandler;
import com.szefi.uml_conference.editor.service.socket.handler.EditorActionHandler;
...
public class WebSocketConfig implements WebSocketConfigurer {
   ...
   // private final static String endpoint="/test";
    ...
    @Bean
    @Scope("prototype")
public ThreadPoolTaskExecutor getNewTaskExecutor() {
